        ...
        http
            ...
            .headers(headers -> headers
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/requests").hasAnyRole("ADMIN", "SUPER_ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/requests/*/status").hasAnyRole("ADMIN", "SUPER_ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/appointments").hasAnyRole("ADMIN", "SUPER_ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/appointments/*/status").hasAnyRole("ADMIN", "SUPER_ADMIN")
                    ...
                    .requestMatchers("/api/subscriptions/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
